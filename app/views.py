...
def candidate(request):
	if request.method == 'POST':
		...
		for row in tables[0].rows:
			...
			dir_path = os.path.join('C:\\Users\\Poshan Baral\Desktop\\personality_prediction\\media')
...
def test(request):
	...
	if request.method=='POST':
		...
		with open('C:\\Users\\Poshan Baral\\Desktop\\personality_prediction\\app\\classifier.pk1', 'rb') as pickle_file:
